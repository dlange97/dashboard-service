...
## Repository-Specific Focus (Dashboard)

- Treat this service as the owner of todo and shopping-list lifecycle.
- Prioritize idempotent updates and predictable state transitions for todo and shopping endpoints.
- Keep extra attention on archive/restore/delete behavior and list filtering consistency.
- Any change to todo/shopping payloads must preserve frontend contract compatibility.
